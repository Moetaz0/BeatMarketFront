    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-72 flex-shrink-0">
          <div class="bg-gray-900 rounded-xl p-6 border border-gray-800 sticky top-20">
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <select class="w-full bg-gray-800 border border-gray-700 rounded-lg py-2 px-4 text-white">
              ...
              <!-- Price Range -->
              <div>
                <label class="block text-gray-400 text-sm mb-2">Starting Price</label>
                <select class="w-full bg-gray-800 border border-gray-700 rounded-lg py-2 px-4 text-white">
              ...
              <!-- More Filters Button -->
              <button class="w-full px-5 py-2 bg-red-600 hover:bg-red-700 rounded-lg text-sm font-medium transition">
                Apply Filters
              </button>
            </div>
          </div>
        ...
        <!-- Main Grid -->
        <div class="flex-1">
          <h1 class="text-3xl font-bold mb-8">Musicians</h1>

<template>
  <div class="min-h-screen bg-[rgba(20,0,0,0.88)] backdrop-blur-xl bg-fixed relative overflow-hidden flex flex-col">
    <!-- Logo -->
    ...
    <div class="flex flex-col lg:flex-row items-center justify-between min-h-screen px-6 lg:px-20 max-w-[1900px] mx-auto w-full">
      ...
      <!-- Guitar Background -->
      <div class="pointer-events-none hidden lg:block absolute top-0 right-[-10%] w-[1100px] h-screen z-10" aria-hidden="true">
        <div
    ...
    <Teleport to="body">
      <transition name="modal">
        ...
        >
          ...
          <div class="relative bg-[rgba(20,0,0,0.95)] backdrop-blur-2xl rounded-2xl p-10 shadow-[0_0_80px_rgba(120,10,10,0.6)] border border-red-800/50 max-w-md w-full">
            <!-- Checkmark -->
            <div class="w-20 h-20 mx-auto mb-6 bg-green-500/20 rounded-full flex items-center justify-center border-4 border-green-500/40">
              <svg class="w-12 h-12 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
              </svg>
            </div>

            <h3 class="text-2xl font-bold text-white text-center mb-3">Check Your Inbox!</h3>

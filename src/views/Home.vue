...
const yourBeats = ref([
  {
    id: 5,
    title: "Your Drill x Afro Fusion",
    producer: "You",
    price: "$34.99",
    cover:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPpsMqkon_oG4YGRLiQ6S0NzVh84DH0C-4DIOypP5cDDH06Sek&s",
    plays: "487",
  },
  {
    id: 6,
    title: "Trap Soul 2025",
    producer: "You",
    price: "$24.99",
    cover:
      "https://consequence.net/wp-content/uploads/2023/04/best-greatest-stoner-weed-albums-all-time.jpg?quality=80",
    plays: "312",
  },
]);
...
const fetchProfile = async () => {
  ...
  try {
    ...
    console.log(
      "Updated authStore with profile data:",
